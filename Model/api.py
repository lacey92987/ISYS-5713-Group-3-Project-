...
class Power:
    ...
    def __init__(self, power_name, power_level, power_type, power_id):
...
class Hero:
    ...
    def __init__(self, hero_name, gender, eye_color, species, hair_color, height, weight, publisher, skin_color, alignment, hero_id, powers=[]):
